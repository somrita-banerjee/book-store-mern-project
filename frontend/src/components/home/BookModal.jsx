        ...
        >
            ...
            >
                <AiOutlineClose
                    ...
                    onClick={onClose}
                />
                <h2 className="w-fit bg-gray-500 text-white px-2 py-1 rounded-lg">
                    {' '}
                    {book.publishYear}{' '}
                </h2>
                ...
                <p className="my-2">
                    ...
                    Dolore eaque ex obcaecati dicta illum molestias quam nisi
                    libero labore, rerum mollitia perspiciatis natus temporibus,
                    aliquam ut quibusdam consequuntur cupiditate laborum?
                </p>
            </div>
        </div>
    );
